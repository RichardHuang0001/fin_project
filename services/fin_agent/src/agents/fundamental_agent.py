...
def _report_window_args(current_data):
...
FUNDAMENTAL_PROFILE = AnalysisProfile(
    ...
    metadata_prefix="fundamental_agent",
    completion_message="基本面分析已完成",
    summary_title="基本面分析代理",
    summary_objective="围绕公司基本信息、行业、盈利、成长、资产负债、现金流与业绩披露给出基本面判断。",
    summary_requirements=[
        "先给出 2 到 4 条核心结论。",
        "明确说明你的关键依据来自哪些已获取的数据。",
        "指出主要风险或数据缺口。",
        "最后给出一句谨慎的基本面判断。",
    ],
    allowed_tools=[
